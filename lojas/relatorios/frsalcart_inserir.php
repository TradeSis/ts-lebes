    ...
    <div class="container" style="width:700px">
        <div class="card shadow">
            <div class="card-header border-1">
                <div class="row">
                    <div class="col-10">
                        <h4 class="col">Relatório - Posição Vencidos e a vencer</h4>
                    </div>
                    <div class="col-2" style="text-align:right">
                        <a href="../consultas/relatorios.php" role="button" class="btn btn-primary btn-sm">Voltar</a>
                    </div>
                </div>
            </div>
            <div class="container" style="margin-top: 10px">
                ...
                <form action="../database/relatorios.php?operacao=frsalcart" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" name="relatnom" class="form-control" value="Posição Vencidos e a vencer" autocomplete="off" readonly>
                    </div>
                    <div class="row">
